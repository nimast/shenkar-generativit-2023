...
var question2 = [
    [
        [
            "https://i.ytimg.com/vi/GSFxVYrnZ8M/hqdefault.jpg",
            "סופי צדקה"
        ],
        [
    ...
    [
        [
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzm3We_ogjXEbMsG2krwC_Yls8RE5qx4gYOA&usqp=CAU",
            "בריטני ספירס"
        ],
        [
            "https://tribona.co.il//media/k2/items/cache/82f87882866fcce76dca31189f8b0135_XL.jpg",
            "זוהר ארגוב"
        ]
    ],
    [
        [
            "https://ynet-pic1.yit.co.il/picserver5/crop_images/2023/05/10/r1SQjRdV3/r1SQjRdV3_0_126_1440_811_0_x-large.jpg",
            "נדיר אליהו"
        ],
        [
            "https://d3o5sihylz93ps.cloudfront.net/wp-content/uploads/sites/5/2020/10/13002005/%D7%A4%D7%A1%D7%98%D7%94-%D7%A8%D7%95%D7%96%D7%94-%D7%91%D7%A2%D7%A6%D7%9E%D7%941.jpg",
            "דניאל עמית"
        ]
    ]
];
var answers = [
    [
        "ערוץ הילדים יעשה קאמבק!",
        "יש לי דוגמנית בת 20 להכיר לך"
    ],
    [
        "תגמרי כמו זוהר ",
        "חיי הזוהר פחותמתאים לך.."
    ],
    [
        "קוד קופון 555",
        "קוד קופון 555"
...
function draw() {
    ...
    if (step == 2) textBoxResult(answers[answerIndex1][answerIndex2], windowWidth / 2.3, windowHeight / 2);
}
function ans1() {
...
function changeStepAndCatchAns(index) {
    if (step == 0) answerIndex1 = index;
    if (step == 1) answerIndex2 = index;
...
//# sourceMappingURL=razg.a492bc06.js.map
